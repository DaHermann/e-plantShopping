...
import {addItem, CartSlice, removeItem, updateQuantity} from './CartSlice'
...
function ProductList({ onHomeClick }) {
    ...
    const handleDesable = (plantName) => {
        const alradyAdded = CartItems.find(item => item.name == plantName)

        console.log (plantName+' : ', alradyAdded )
        return  alradyAdded ? true : false;
    }
                                ...
                                {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                                    <div className="product-card" key={plantIndex}> {/* Unique key for each plant card */}
                                        ...
                                        <button
                                            ...
                                            disabled={handleDesable(plant.name)}
                                        >
                                            Add to Cart
                                        </button>
                                    </div>
